...
- [ ] Normalize error-free portable inspection into a canonical plugin and source digest.
- [ ] Implement staged, verified, atomic compilation and prior-output preservation on failure.
- [ ] Implement isolated regenerate-and-diff verification and payload build/verify scripts.
- [ ] Build, typecheck, and test affected packages; merge `story/age-16-deterministic-compiler` into the Feature branch.
...
- [ ] Pass the shared conformance suite; merge `story/age-17-cursor-adapter` into the Feature branch.
...
- [ ] Pass the shared conformance suite; merge `story/age-18-claude-adapter` into the Feature branch.
...
- [ ] Pass the shared conformance suite; merge `story/age-19-codex-adapter` into the Feature branch.
...
- [ ] Cover every mutation fault point and exact managed-state restoration; merge `story/age-20-transactional-installer` into the Feature branch.
...
- [ ] Cover all three vendors and failure result variants; merge `story/age-21-install-command` into the Feature branch.
...
- [ ] Run cross-platform quality gates; merge `story/age-22-release-evidence` into the Feature branch.
...
- [ ] Run the full milestone acceptance audit; merge `story/age-23-docs-release` into the Feature branch.
